# Chiu_AuAc module
# Function 1: the "Reduced" model    
def Reduced(Testing_dataset):
    ...
    class Model10(torch.nn.Module):
        ...
        def forward(self, x):
            ...
            return y_pred;
    # Sec3: data prepping
    scaler=pickle.load(open('Reduced_Coef.pkl','rb'));
    ...
    trained_model.load_state_dict(torch.load('Reduced.pkl'));
