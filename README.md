...
- `v2.0.0` (expeceted on 03/01/2021): `Keras-Tensoflow` as the backend (another option)
- `v3.0.0` (expected on 03/01/2021): a `Fortran` version of the pacakge will be published
